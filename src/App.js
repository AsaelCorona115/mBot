        ...
        <div className="content">
          <Switch>
            ...
            <Route path="/mBotCourse">
              <CourseMainPage
                courseName="mBot"
                description="This course is intended for beginners! Have you ever used an IDE? Do you know what a loop is? No? Well then this course is for you. Intended for people who have never coded before, here you will learn about basic programming concepts that can be applied to any coding language using the mBot! An affordable and educational robot that can be programmed using Scratch. Take you first steps to becoming a programmer!"
